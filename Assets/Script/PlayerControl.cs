    ...
    private bool is_attack_input()
    {
        ...
        if (SceneControl.IS_AUTO_ATTACK)
        {
            ...
            foreach (GameObject oni_group in oni_groups)
            {
                ...
                float time_left = distance / (this.GetComponent<Rigidbody>().velocity.x -
                                              oni_group.GetComponent<OniGroupControl>().run_speed);
                ...
                if (this.is_attack_input())
                {
                    ...
                    switch (this.attack_motion)
                    {
                        ...
                        case ATTACK_MOTION.RIGHT:
                            this.attack_motion = ATTACK_MOTION.LEFT;
                            break;
                        case ATTACK_MOTION.LEFT:
                            this.attack_motion = ATTACK_MOTION.RIGHT;
                            break;
                    }
                    ...
                    switch (this.attack_motion)
                    {
                        default:
                        case ATTACK_MOTION.RIGHT:
                            this.animator.SetTrigger("attack_r");
                            break;
                        case ATTACK_MOTION.LEFT:
                            this.animator.SetTrigger("attack_l");
                            break;
                    }
